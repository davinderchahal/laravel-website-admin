    ...
    <form class="form" method="post" action="{{ route('login') }}">
        ...
        <div class="card card-login card-white">
            <div class="card-header">
                <img src="{{ Vite::assets('img/card-primary.png') }}" alt="">
                <x-application-logo width="100" style="left:33%; top:4%"></x-application-logo>
                <h1 class="card-title">&nbsp</h1>
            </div>
            <div class="card-body">
                <p class="text-dark mb-2">Sign in with <strong>email</strong> and the <strong>password</strong></p>
